...
Uma matriz é uma coleção bidimensional (ou multidimensional) de elementos do mesmo tipo. 
As estruturas de repetição são essenciais para percorrer e manipular matrizes. 
Veja um exemplo de como inicializar e exibir os elementos de uma matriz.
